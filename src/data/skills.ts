...
export const SKILLS: ISkill[] = [
  ...
  },
  {
    name: 'Visual Basic',
    type: SkillType.Language,
    icon: 'assets/icons/visual-basic.png',
    color: '#945db7',
  },
  {
    name: 'Java',
  ...
  },
  {
    ...
    type: SkillType.Language,
    icon: 'assets/icons/game-maker-language.png',
    color: '#8fb200',
  },
  ...
  { name: 'React', type: SkillType.Framework, icon: 'assets/icons/react.png' },
  {
    name: 'Storybook',
    type: SkillType.Framework,
    icon: 'assets/icons/storybook.png',
  },
  {
    name: 'TailwindCss',
    type: SkillType.Framework,
  ...
  { name: '.Net', type: SkillType.Framework, icon: 'assets/icons/dotnet.png' },
  {
    name: 'ASP.Net',
    type: SkillType.Framework,
    icon: 'assets/icons/net-core.png',
  },
