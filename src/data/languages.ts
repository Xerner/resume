...
export const LANGUAGES: ILanguage[] = [
  ...
  { name: "Web Ontology Language", color: "#9cc9dd" },
  ...
  { name: "Unity3D Asset", color: "#ab69a1" },
  { name: "Nu", color: "#c9df40" },
  { name: "LFE", color: "#004200" },
  ...
  { name: "Pascal", color: "#b0ce4e" },
  { name: "F#", color: "#b845fc" },
  { name: "Puppet", color: "#302B6D" },
  { name: "ActionScript", color: "#882B0F" },
  { name: "Diff", color: "#88dddd" },
  { name: "Ragel in Ruby Host", color: "#9d5200" },
  { name: "Fantom", color: "#dbded5" },
