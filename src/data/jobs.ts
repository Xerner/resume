...
export const JOBS: IJob[] = [
  ...
  },
  {
    ...
    occupationId: "7078AFDD-5BC8-4831-90B5-E427273D583E",
    description: "Created an SQL change tracker to automate migrations saving 4 hours of work per dev per week"
  },
  {
  ...
  },
  {
    ...
    description: "Architected, developed, and documented a validation and reporting application for J2534 (CAN) signals. The application saved validation engineers 8 hours per week of testing"
  },
  {
    id: "F5E33D93-ACD1-470D-9C33-265FA084E5E0",
    occupationId: "7B9CD2A8-F374-4CF3-871A-EEEBDA326C14",
    description: "Integrated and unit tested an existing platform-level performance testing framework into the teams codebase and CI/CD pipeline. Using the existing framework saved the team 6 months of development time"
  },
  {
  ...
  },
  {
    ...
    description: "Automated processing test data for carbon canisters GWC/BWC tests saving test engineers 20 hours per week of data processing"
  },
  {
  ...
  },
  {
    ...
    occupationId: "1B14C1B3-469B-4E97-A371-F359A6F96670",
    description: "Worked with management to automate, analyze, and report employee key performance indicator (KPI) data. This data went to prove the high performance of the team to upper management"
  },
  {
